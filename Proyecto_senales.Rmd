...
# Definir el porcentaje para el conjunto de entrenamiento (por ejemplo, 70%)
train_index <- createDataPartition(features_df$jazz, p = 2/3, list = FALSE)
...
# Convertir test_labels en factores para comparación
